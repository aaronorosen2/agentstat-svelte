...
<div class="main">
    <div class="left">
        ...
        <h1>SMS Helper</h1>
        <h4>Drafts a text message that you can send to a client or prospect.</h4>
        <div class="typearea">
            <h3>Describe message</h3>
            <h6>Explain who the text message is for and the purpose of the message</h6>
