<script>
    import PasswordResetConfirm from '../../components/PasswordReset/PasswordResetConfirm.svelte';
...
<div>
    <div class="login">
        ...
        <div class="login--box">
            <div class="tabs">
                <div class="tab" class:selected={tab=='reset-password'}>Verification Window</div>
            </div>
            <div class="forms">
