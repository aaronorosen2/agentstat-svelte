...
<div class="profile-details">
    ...
    <img src={agent.picture == null && agent.s3_image == null ? "/images/blank-profile-pic.webp" : `https://app.realtorstat.com/api/agent/pic/WA/${agent.picture || agent.s3_image}`} alt="not found" >
